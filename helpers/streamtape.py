...
async def UploadToStreamtape(file: str, editable: Message, file_size: int):
    try:
        async with aiohttp.ClientSession() as session:
            ...
            await editable.edit(text_edit, parse_mode=ParseMode.HTML, disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Open Link", url=download_link)]]))
